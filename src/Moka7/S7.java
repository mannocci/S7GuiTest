...
public class S7 {
     ...
     * @return a 16 bit unsigned value : from 0 to 65535 (2^16-1)
     */
     ...
     * @param Buffer
     * @param Pos
     * @return a 16 bit signed value : from -32768 to 32767
     */
     ...
     * @param Buffer
     * @param Pos
     * @return a 32 bit unsigned value : from 0 to 4294967295 (2^32-1)
     */
     ...
     * @param Buffer
     * @param Pos
     * @return a 32 bit signed value : from 0 to 4294967295 (2^32-1)
     */
     ...
     * @param Pos
     * @param MaxLen
     * @return an ASCII string with the charset is UTF-8
     */
