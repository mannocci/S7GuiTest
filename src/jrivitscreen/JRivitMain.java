...
//        }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabelContatore.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jLabelContatore.setBounds(20, 90, 210, 16);
        ...
        jLabelNomeDevice.setBounds(17, 20, 210, 22);

        jLabelNomeLavoro.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jLabelNomeLavoro.setBounds(20, 50, 210, 16);

        jProgressBar.setBorder(javax.swing.BorderFactory.createTitledBorder("1%"));
        jPanelStarted.add(jProgressBar);
        jProgressBar.setBounds(6, 174, 230, 40);

        jLabelErrati.setBackground(java.awt.Color.red);
        jLabelErrati.setFont(new java.awt.Font("Serif", 0, 18)); // NOI18N
        ...
        jLabelAnnullati.setFont(new java.awt.Font("Serif", 0, 18)); // NOI18N
        ...
        jLabelValidi.setFont(new java.awt.Font("Serif", 0, 18)); // NOI18N
        ...
        listLavori.setBounds(40, 30, 160, 180);
 ...
 */
    private void jButtonPR1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPR1ActionPerformed
      ...
      switch (this.FocusPanelName) {
        case "main" -> PanelStart();
        case "start" -> PulsanteSu();
        case "started" -> {
          this.AllertDialogStop = "Annullare il Lavoro ?";
          this.jLabelDialog.setText(AllertDialogStop);
          PanelDialog();
      }
        case "setup" -> PanelSetupLan();
        case "warning" -> PulsanteSu();
        case "info" -> PulsanteSu();
        case "setup lan" -> PulsanteSu();
        case "setup wifi" -> PulsanteSu();
        case "dialog" -> {
 ...
 */
    private void jButtonPL1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPL1ActionPerformed
      // Pulsante L1
      switch (this.FocusPanelName) {
        case "main" -> PanelWarning();
        case "start" -> PanelMain();
        case "started" -> PanelStart();
        case "setup" -> PanelMain();
        case "warning" -> PanelMain();
        case "info" -> PanelMain();
        case "setup lan" -> PulsanteSu();
        case "setup wifi" -> PulsanteSu();
        case "dialog" -> PanelStart();
      }
 ...
 */
    private void jButtonPR2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPR2ActionPerformed
      ...
      switch (this.FocusPanelName) {
        case "main" -> PanelStart();
        case "start" -> PulsanteGiu();
        case "started" -> {
          this.AllertDialogStop = "Lavoro in Pausa ?";
          PanelDialog();
      }
        case "setup" -> PanelSetupLan();
        case "warning" -> PulsanteGiu();
        case "info" -> PulsanteGiu();
        case "setup lan" -> PulsanteGiu();
        case "setup wifi" -> PulsanteGiu();
        case "dialog" -> PanelStarted();
      }
 ...
 */
    private void jButtonPR3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPR3ActionPerformed
      ...
      switch (this.FocusPanelName) {
        ...
        case "warning" -> PulsanteSu();
        case "info" -> PulsanteSu();
        case "setup lan" -> PanelSetup();
        case "setup wifi" -> PanelSetup();
        case "dialog" -> PanelStart();
      }
 ...
 */
  ...
  /**
   * Show PanelStart
   * da questo pannello si fa la scelta del lavoro dalla lista creata da JControl
   * nel file lavori.txt
   */
...
/**
 * Pannello dopo aver fatto la scelta del Lavoro, tale scelta deve essere scritta
 * nel file /tmp/lavoro_scelto.txt
 * L'App JControl sollecitato dall'evento modifica lavoro_scelto o creazione
 * del file, aggiorna il DB (DA FARE)
 * Mostra il conteggio dei tiri e la barra di avanzamento dei lavori, ...
 */
...
/**
 * Alla pressione del pulsante che simula la freccia in su
 * muovendosi sulla lista
 */
  private void PulsanteSu() {
    ...
    switch (this.FocusPanelName) {
      case "start" -> lista = this.listLavori;
...
/**
 * Pannello per la configurazione della LAN
 * Legge il file /tmp/setup_lan.txt
 */
...
/**
 * Pannello per il setup della WiFi
 * Legge il file /tmp/setup_wifi.txt
 */
...
/**
 * Pannello necessario per la conferma della scelta Stop/Pausa del lavoro
 * Lo Stop cancella il lavoro, la pausa memorizza (file pausa.txt) 
 * il nome del Lavoro messo in Pausa. L'APP Control alla creazione del file
 ...
 */
  ...
  public void pulsante_hw(String p) {
    switch (p) {
      case "PL1" -> jButtonPL1ActionPerformed(null);
      case "PL2" -> jButtonPL2ActionPerformed(null);
      case "PL3" -> jButtonPL3ActionPerformed(null);
      case "PR1" -> jButtonPR1ActionPerformed(null);
      case "PR2" -> jButtonPR2ActionPerformed(null);
      case "PR3" -> jButtonPR3ActionPerformed(null);
    }
  }
/**
